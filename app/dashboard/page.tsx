...
export default function DashboardCalendar() {
  ...
  useEffect(() => {
    api.getProgressAnalytics()
      ...
      .catch((e) => { console.error(e); setProgressError(e.message); setProgress(null); })
...
function ProgressAnalytics({ progress, loading, error }) {
    ...
    <div style={styles.progressCard}>
      ...
      {loading ? (
        ...
        <div style={styles.analyticsGrid}>
          ...
          <div style={styles.analyticsStat}>
            <span style={styles.analyticsLabel}>Focus Score</span>
            <span style={styles.analyticsValue}>{sessions.avg_focus_score ?? "—"}</span>
            <span style={styles.analyticsSub}>Average score</span>
          </div>
          <div style={styles.analyticsStat}>
